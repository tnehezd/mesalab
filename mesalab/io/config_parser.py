# mesalab/io/config_parser.py - REVISED for new GYRE config structure and CLI args
...
def parsing_options():
    ...
    gyre_group.add_argument('--filtered-profiles-csv-name', type=str,
                            help='Override gyre_workflow.filtered_profiles_csv_name. Custom name for the GYRE input CSV generated by mesa_analyzer.')
    ...
    for arg_action in parser._actions:
        ...
        if isinstance(arg_action, argparse._StoreTrueAction) or isinstance(arg_action, argparse._StoreFalseAction):
            ...
            if cli_value is not None: # Means it was present in CLI args
                ...
                # Special case: If default is False and cli_value is False (i.e. --no-arg), it was explicitly provided.
                # if arg_action.default is False and cli_value is False: # This can happen with --no-plots style flags
                #     cli_set_explicitly = True
        else:
        ...
        if cli_set_explicitly:
            ...
            elif arg_name == 'filtered_profiles_csv_name':
                final_config_dict.gyre_workflow.filtered_profiles_csv_name = cli_value
    ...
    if final_config_dict.gyre_workflow.run_gyre_workflow:
...
if __name__ == '__main__':
    ...
    try:
        ...
        print(f"Filtered Profiles CSV Name: {parsed_config.gyre_workflow.filtered_profiles_csv_name}")
