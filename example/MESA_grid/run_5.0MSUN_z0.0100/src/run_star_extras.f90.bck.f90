...
!!        vals(12) = s% gamma1(1)  !!! these might be labeled backwards 6/19/23
        !write(*,*) 'gamma1_top, gamma1_bottom', s% gamma1(s% nz), s% gamma1(1)
...
!!                 print *, '  (1)  Found mode: l, n_p, n_g, E, nu, eta =      ', &
...
!!                    md%eta()
              ...
              !!   print*, '---------------'
                    ...
                    print *, '  (2)  Found mode: l, n_p, n_g, E, nu, eta =      ', &
                       freq, etas
